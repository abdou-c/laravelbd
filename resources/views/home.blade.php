...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h1>Abdourahmane Sow</h1></div>
                ...
                <div class="card-body">
                    ...
                    {{-- <h5>let's do it!!!!
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-emoji-laughing" fill="#ff3838" xmlns="http://www.w3.org/2000/svg">
